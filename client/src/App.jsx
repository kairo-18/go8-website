...
const App = () => {
  ...
  return (
    <>
      <Navbar />
      <Parallax pages={6} className="overflow-hidden">
        ...
        {/* Values Section */}
        <ParallaxLayer offset={1} speed={0.5} factor={1.2}>
          <Values />
        </ParallaxLayer>

        {/* Projects Section */}
        <ParallaxLayer offset={2} speed={0.3} factor={1.5}>
          <motion.div
            ...
            id="projects"
            className="w-full h-full bg-white dark:bg-black text-black dark:text-white pt-10 overflow-hidden"
            style={{
          ...
          >
            ...
            <div className="space-y-10 md:space-y-0 px-4 w-full max-w-full">
              <motion.div
                ...
                className="w-full max-w-full overflow-visible min-w-[200px] min-h-[40vh]"
              >
                <Project
